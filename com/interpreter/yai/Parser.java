...
class Parser {
        ...
        if(!check(TokenType.RIGHT_PAREN)) {
            do {
                if(parameters.size() >= 255) {
                    error(peek(), "Cannont have more than 255 parameters.");
                }
    ...
    private Stmt forStatement() {
        ...
        body = new Stmt.While(condition, body,
            increment == null ? null : (new Stmt.Expression(increment)));
    ...
    private Stmt continueStatement() {
        Stmt continueStmt = new Stmt.Continue(previous());
    ...
    private Expr call() {
        ...
        while(true) {
            if(match(TokenType.LEFT_PAREN)) {
                ...
                Token name = consume(TokenType.IDENTIFIER, "Expect property namne after '.'.");
